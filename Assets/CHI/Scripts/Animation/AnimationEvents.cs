...
public class AnimationEvents : MonoBehaviour
{
    ...
    {
        //print("SET BOOL IN ANIMATION EVENT CALLED");
    ...
    {
        //print("SET INTEGER IN ANIMATION EVENT CALLED");
        //var parts = value.Split('=');
    ...
    {
        //print("SET EXPRESSION IN ANIMATION EVENT CALLED");
    ...
    {
        //print("RESET ANIMATION IN ANIMATION EVENT CALLED");
